...
public class MenuGuiWindow extends ContainerScreen<MenuGui.GuiContainerMod> {
	...
	private static final ResourceLocation texture = new ResourceLocation("mcw:textures/screens/menu.png");
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Si vous appuyez sur ECHAP, vous devrez quitter", 48, 189, -10066330);
		this.font.drawString(ms, "Joueur en ligne :", -122, 184, -3355444);
		this.font.drawString(ms, "" + (McwModVariables.MapVariables.get(world).PlayerPresentInGame) + "", -29, 185, -256);
	}
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + -105, this.guiTop + -10, 119, 20, new StringTextComponent("Choisir une carte"), e -> {
			if (true) {
				McwMod.PACKET_HANDLER.sendToServer(new MenuGui.ButtonPressedMessage(0, x, y, z));
