...
public class BoutonAlfaTerminalProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				McwMod.LOGGER.warn("Failed to load dependency world for procedure BoutonAlfaTerminal!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				McwMod.LOGGER.warn("Failed to load dependency x for procedure BoutonAlfaTerminal!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				McwMod.LOGGER.warn("Failed to load dependency y for procedure BoutonAlfaTerminal!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				McwMod.LOGGER.warn("Failed to load dependency z for procedure BoutonAlfaTerminal!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				McwMod.LOGGER.warn("Failed to load dependency entity for procedure BoutonAlfaTerminal!");
			return;
		}
		...
		if (McwModVariables.MapVariables.get(world).EquipeALFA1 >= 1 && McwModVariables.WorldVariables.get(world).EquipeDELTA1 >= 1) {
			...
			}
			{
				...
				entity.getCapability(McwModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
					capability.LoadScreenTerminal = _setval;
				...
				private void run() {
					{
						...
						if (!_ent.world.isRemote && _ent.world.getServer() != null) {
							_ent.world.getServer().getCommandManager()
									.handleCommand(_ent.getCommandSource().withFeedbackDisabled().withPermissionLevel(4), "tag @s add Terminal");
						}
					}
					{
					...
					McwModVariables.MapVariables.get(world).NbJoueurTotalTerminal = (McwModVariables.MapVariables.get(world).NbJoueurTotalTerminal
							+ 1);
					McwModVariables.MapVariables.get(world).syncData(world);
					{
						Entity _ent = entity;
					...
					McwModVariables.MapVariables.get(world).syncData(world);
					{
						...
						if (!_ent.world.isRemote && _ent.world.getServer() != null) {
							_ent.world.getServer().getCommandManager().handleCommand(
									_ent.getCommandSource().withFeedbackDisabled().withPermissionLevel(4), "playsound mcw:spawn neutral @s");
						}
					}
					{
						Entity _ent = entity;
						if (!_ent.world.isRemote && _ent.world.getServer() != null) {
							_ent.world.getServer().getCommandManager().handleCommand(
									_ent.getCommandSource().withFeedbackDisabled().withPermissionLevel(4), "playsound mcw:goodtogo neutral @s");
						}
					}
		...
		} else if (McwModVariables.WorldVariables.get(world).EquipeDELTA1 <= 0) {
			McwModVariables.MapVariables.get(world).TerminalAttente = (true);
			McwModVariables.MapVariables.get(world).syncData(world);
			{
				Entity _ent = entity;
				if (!_ent.world.isRemote && _ent.world.getServer() != null) {
			...
			new Object() {
				...
				private void run() {
					...
					McwModVariables.MapVariables.get(world).DebutPartieTextTerminal = "Attente de l'\u00E9quipe";
					McwModVariables.MapVariables.get(world).syncData(world);
					new Object() {
						private int ticks = 0;
						private float waitTicks;
						...
						private void run() {
							...
							IfDelta1eg1Procedure.executeProcedure(Stream
										...
										private void run() {
											...
											new Object() {
												...
												private void run() {
													...
													IfDelta1eg1Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world),
																						...
																						private void run() {
																							...
																							new Object() {
																								...
																								private void run() {
																									...
																									IfDelta1eg1Procedure.executeProcedure(Stream.of(
																											new AbstractMap.SimpleEntry<>("world",
																													world),
																											new AbstractMap.SimpleEntry<>("x", x),
																											new AbstractMap.SimpleEntry<>("y", y),
																											new AbstractMap.SimpleEntry<>("z", z),
																																																																																																																																																																						...
																																																																																																																																																																						private void run() {
																																																																																																																																																																							...
																																																																																																																																																																							new Object() {
																																																																																																																																																																								...
																																																																																																																																																																								private void run() {
																																																																																																																																																																									...
																																																																																																																																																																									DisconnectTerminalGameProcedure
																																																																																																																																																																											.executeProcedure(
																																																																																																																																																																													Stream.of(
																																																																																																																																																																															new AbstractMap.SimpleEntry<>(
																																																																																																																																																																																	"world",
		...
		} else if (McwModVariables.WorldVariables.get(world).EquipeDELTA1 >= 1) {
			{
				Entity _ent = entity;
				if (!_ent.world.isRemote && _ent.world.getServer() != null) {
					_ent.world.getServer().getCommandManager().handleCommand(_ent.getCommandSource().withFeedbackDisabled().withPermissionLevel(4),
																	...
																	new Object() {
																		...
																		private void run() {
																			McwModVariables.MapVariables.get(
																					world).DebutPartieTextTerminal = "    \u00A7ut de la partie dan=";
																			McwModVariables.MapVariables.get(world).syncData(world);
																			new Object() {
																				private int ticks = 0;
																				private float waitTicks;
