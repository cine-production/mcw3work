...
public class BoutonDeltaTerminalProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				McwMod.LOGGER.warn("Failed to load dependency world for procedure BoutonDeltaTerminal!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				McwMod.LOGGER.warn("Failed to load dependency x for procedure BoutonDeltaTerminal!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				McwMod.LOGGER.warn("Failed to load dependency y for procedure BoutonDeltaTerminal!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				McwMod.LOGGER.warn("Failed to load dependency z for procedure BoutonDeltaTerminal!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				McwMod.LOGGER.warn("Failed to load dependency entity for procedure BoutonDeltaTerminal!");
			return;
		}
		...
		} else if (McwModVariables.MapVariables.get(world).EquipeALFA1 <= 0) {
				...
				private void run() {
					...
					new Object() {
						...
						private void run() {
							...
							IfAlfa1eg1Procedure.executeProcedure(Stream
										...
										private void run() {
											...
											new Object() {
												...
												private void run() {
													...
													IfAlfa1eg1Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world),
																						...
																						private void run() {
																							...
																							new Object() {
																								...
																								private void run() {
																									...
																									IfAlfa1eg1Procedure.executeProcedure(Stream.of(
		...
		} else if (McwModVariables.MapVariables.get(world).EquipeALFA1 >= 1) {
			{
				Entity _ent = entity;
				if (!_ent.world.isRemote && _ent.world.getServer() != null) {
					_ent.world.getServer().getCommandManager().handleCommand(_ent.getCommandSource().withFeedbackDisabled().withPermissionLevel(4),
